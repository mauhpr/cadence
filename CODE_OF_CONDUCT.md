...
[mauricio_perez_r@hotmail.com](mailto:mauricio_perez_r@hotmail.com) with the
subject prefix `[CONDUCT][Cadence]`. Do not open a public issue. All
complaints will be reviewed and investigated promptly and fairly.

Community leaders are obligated to respect the privacy and security of anyone
...
of the violation and why the behavior was inappropriate. A public apology may
be requested.
...
the community for a specified period, including no public or private interaction
with the people involved or those enforcing the Code of Conduct. Violating these
...
version 2.1, available at the [Contributor Covenant 2.1 text][v2.1].
